...
<div class="row">
    <div class="col-md-12">        
        <a class="btn btn-sm btn-danger pull-right" href="{{ route('soal') }}" ><i class="icon-arrow-left"></i>
            Kembali</a>
    </div>
</div>
<div class="card bg-light border-primary mt-2">
    <div class="card-header">Form Tambah Soal</div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-4">
            ...
            <!-- Form Non TKP -->
            <div id="formnontkp" style="display:none;">
                <form id="form" method="POST" action="{{ route('soal.store') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="jenis" id="jenis_id" value="">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm bidang @if ($errors->has('bidang')) is-invalid  @endif" id="bidang" name="bidang">
                                    <option selected disabled>- pilih bidang soal -</option>
                                </select>
                                @error('bidang')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm subbidang @if ($errors->has('subbidang')) is-invalid  @endif" id="subbidang" name="subbidang">
                                    <option selected disabled>- pilih sub bidang soal -</option>
                                </select>
                                @error('subbidang')
                                <div class="invalid-feedback">
                                    {{ $message }}
            ...
            <!-- Form TKP -->
            <div id="formtkp" style="display:none;">
                <form id="form" method="POST" action="{{ route('soal.store') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="jenis" id="jenis-id" value="">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="bidang">Bidang Soal</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="deskripsi">Deskripsi Soal</label>
                                <textarea class="form-control" name="deskripsi" id="ckeditorDesc"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="opsi1">Pilihan Jawaban A</label>
                                <textarea class="form-control" name="opsi1" id="ckeditor-A"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="opsi3">Pilihan Jawaban B</label>
                                <textarea class="form-control" name="opsi2" id="ckeditor-B"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="opsi5">Pilihan Jawaban C</label>
                                <textarea class="form-control" name="opsi3" id="ckeditor-C"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="opsi2">Pilihan Jawaban D</label>
                                <textarea class="form-control" name="opsi4" id="ckeditor-D"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="opsi4">Pilihan Jawaban E</label>
                                <textarea class="form-control" name="opsi5" id="ckeditor-E"></textarea>
                            </div>
                            <div class="mt-5">
                            ...
                            <div class="form-group mt-3">
                                <label for="jawaban">Jawaban Benar</label>
                                <input type="text" readonly id="jawaban" class="form-control form-control-sm @if ($errors->has('jawaban')) is-invalid  @endif" name="jawaban">
                                @error('jawaban')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
...
@push('ckeditor')
    ...
    <script>
        CKEDITOR.replace('ckeditor', {
            filebrowserUploadUrl: "{{route('soal.image', ['_token' => csrf_token() ])}}",
