    ...
    <div>
        ...
        <div class="row mb-3 mt-4">
            <div class="col-md-6">
                ...
                <a href="{{ route('livescore-skb') }}" target="_blank" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="livescore"><i class="icon-list-ol"></i> Livescore</a>
...
<div class="modal fade" id="resetwaktu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post" action="{{ route('reset-waktu-ujian-skb') }}">
