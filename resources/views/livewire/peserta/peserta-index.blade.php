<div>
    <div>
        ...
        @if ($updateMode)
            @include('livewire.peserta.update')
        @else
            @include('livewire.peserta.create')
        @endif
        ...
        <div class="row mb-3">
            <div class="col-md-10">
                ...
                <a href="{{ route('export') }}" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="export peserta"><i class="fa fa-file-excel"></i> Export</a>
        ...
        <form method="post" action="{{ route('import') }}" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <a href="{{ url('/admin/download') }}" class="btn btn-sm btn-success"><i class="fa fa-file-excel"></i> Download format</a>
                    </div>
...
<div class="modal fade" id="blokir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post" action="{{ route('blokir-peserta-skd') }}">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <select class="form-control form-control-sm" name="sesi">
                            @php $sesi = App\Peserta::getSesi(); @endphp
                            @foreach ($sesi as $s)
...
<div class="modal fade" id="unblock" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post" action="{{ route('unblock-peserta-skd') }}">
            <div class="modal-content">
                <div class="modal-header">
