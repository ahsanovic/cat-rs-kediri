        ...
        <div class="btn-toolbar ml-2" role="toolbar" aria-label="Toolbar with button groups">
            ...
            <div class="btn-group mr-1" role="group" style="margin-left: 2px; margin-bottom: 2px;">
                <a 
                    ...
                    data-soal="{{ route('ujian-sim.show', ['id' => $nomor_soal]) }}"
                    class="btn btn-<?php 
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col md-6 lg-12 mt-4 d-flex">
                        <button 
                            type="submit" 
                            data-url="{{ route('ujian-sim.update', ['id' => $nomor_sekarang]) }}" 
                            data-next="{{ route('ujian-sim.show', ['id' => $nomor_sekarang + 1]) }}"
                    ...
                    <a 
                        ...
                        data-url="{{ route('ujian-sim.show', ['id' => $nomor_sekarang + 1]) }}" 
                        id="btn-skip" 
                        href="#">Lewati Soal
                    </a>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-4">Email / Username</div>
            ...
            <div class="modal-footer">
                ...
                <form id="form-destroy">
                    <button 
                        type="submit" 
                        data-id="{{ Auth::guard('peserta-sim')->user()->id }}"
                        data-delete="{{ route('ujian-sim.destroy', ['peserta' => Auth::guard('peserta-sim')->user()->id]) }}"
                        data-dismiss="modal"
...
@push('ajax')
    <script>
        ...
        $('#btn-save').click(function(event) {
            ...
            let urlMax = "{{ route('ujian-sim.show', 100) }}";
