        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col md-6 lg-12 mt-4 d-flex">
                    ...
                    <a 
                        class="btn btn-sm btn-danger <?php if ($nomor_sekarang == 25) echo 'disabled'; ?>" 
...
@push('ajax')
    <script>
        ...
        $('#btn-save').click(function(event) {
            ...
            let urlMax = "{{ route('ujian-skb.show', 25) }}";
