        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col md-6 lg-12 mt-4 d-flex">
                    ...
                    <a 
                        class="btn btn-sm btn-danger <?php if ($nomor_sekarang == 50) echo 'disabled'; ?>" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-8">: &nbsp; {{ 50 - $jawaban_kosong }}</div>
                </div>
                <div class="row">
...
@push('ajax')
    <script>
        ...
        $('#btn-save').click(function(event) {
            ...
            let urlMax = "{{ route('ujian-skb.show', 50) }}";
