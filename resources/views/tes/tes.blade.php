        ...
        <div class="btn-toolbar ml-2" role="toolbar" aria-label="Toolbar with button groups">
            ...
            <div class="btn-group mr-1" role="group" style="margin-left: 2px; margin-bottom: 2px;">
                <a 
                    ...
                    data-soal="{{ route('ujian.show', ['id' => $nomor_soal]) }}"
                    class="btn btn-<?php 
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav navbar-nav">
                    <li class="nav-item">
                        ...
                        <small>{{ Auth::guard('peserta')->user()->nama .' - '. Auth::guard('peserta')->user()->nik .' / Sesi '. Auth::guard('peserta')->user()->sesi }}</small>
                    </li>
                </ul>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col md-6 lg-12 mt-4 d-flex">
                        <button 
                            type="submit" 
                            data-url="{{ route('ujian.update', ['id' => $nomor_sekarang]) }}" 
                            data-next="{{ route('ujian.show', ['id' => $nomor_sekarang + 1]) }}"
                    ...
                    <a 
                        ...
                        data-url="{{ route('ujian.show', ['id' => $nomor_sekarang + 1]) }}" 
                        id="btn-skip" 
                        href="#">Lewati Soal
                    </a>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-8">: &nbsp; {{ Auth::guard('peserta')->user()->nama }}</div>
                </div>
                <div class="row">
                    <div class="col-4">NIK</div>
                    <div class="col-8">: &nbsp; {{ Auth::guard('peserta')->user()->nik }}</div>
                </div>
                <!--<div class="row">
                    <div class="col-4">NIPTT-PK</div>
                    <div class="col-8">: &nbsp; {{ Auth::guard('peserta')->user()->nip }}</div>
                </div>-->
                <div class="row">
            ...
            <div class="modal-footer">
                ...
                <form id="form-destroy">
                    <button 
                        type="submit" 
                        data-id="{{ Auth::guard('peserta')->user()->id }}"
                        data-delete="{{ route('ujian.destroy', ['peserta' => Auth::guard('peserta')->user()->id]) }}"
                        data-dismiss="modal"
...
@push('ajax')
    <script>
        ...
        $('#btn-save').click(function(event) {
            ...
            let urlMax = "{{ route('ujian.show', 100) }}";
